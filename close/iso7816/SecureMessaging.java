...
public class SecureMessaging {
	...
	public ResponseAPDU unwrap(ResponseAPDU rapdu) throws SecureMessagingException {
		...
		while (pointer < rapduBytes.length) {
			...
			try {
				ASN1Primitive primitive = asn1sp.readObject();
				encodedBytes = primitive.getEncoded();
				asn1sp.close();
			} catch (IOException e) {
				throw new SecureMessagingException(e);
			}
			...
			try {
				switch (encodedBytes[0]) {
					case (byte) 0x87:
						do87 = new DO87();
						ASN1Primitive primitive87 = asn1in.readObject();
						do87.fromByteArray(primitive87.getEncoded());
						break;
					case (byte) 0x99:
						do99 = new DO99();
						ASN1Primitive primitive99 = asn1in.readObject();
						do99.fromByteArray(primitive99.getEncoded());
						break;
					case (byte) 0x8E:
						do8E = new DO8E();
						ASN1Primitive primitive8E = asn1in.readObject();
						do8E.fromByteArray(primitive8E.getEncoded());
				}
				asn1in.close();
			} catch (IOException e) {
				throw new SecureMessagingException(e);
